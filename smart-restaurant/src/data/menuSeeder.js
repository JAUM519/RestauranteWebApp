...
export const MENUS = [
  ...
  { id: 'latte', name: 'Latte', parentId: 'caliente', kind: 'item', price: 8.5, img: '/menu/latte.jpg' },
  { id: 'capuccino', name: 'Capuccino', parentId: 'caliente', kind: 'item', price: 9.0, img: '/menu/capuccino.jpg' },
  { id: 'frappe', name: 'Frappe', parentId: 'frio', kind: 'item', price: 10.0, img: '/menu/frappe.jpeg' },
  { id: 'brownie', name: 'Brownie', parentId: 'postres', kind: 'item', price: 6.0, img: '/menu/brownie.jpg' },
]
